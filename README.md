...
建议先读 [00-阅读指引](docs/项目全流程/00-阅读指引.md)，了解证据强度四档、事实与推断的区分以及常用术语。

**规则层文档**

- [01-背景](docs/项目全流程/01-背景.md)：说明项目为什么存在，以及手工优化与自动化在风险和知识结构上的差异。
- [02-需求与边界](docs/项目全流程/02-需求与边界.md)：定义目标、非目标、硬约束、验收标准和不可逆操作红线。
- [03-已有方案调研](docs/项目全流程/03-已有方案调研.md)：对照官方能力、商业工具、开源实现和中文资料，明确现有缺口与自研边界。
- [04-方法论设计](docs/项目全流程/04-方法论设计.md)：给出 9 层诊断、核心公式、阈值判据和动作建议的规则层设计。
- [05-理论验证](docs/项目全流程/05-理论验证.md)：记录多轮交叉验证、证据强度、被推翻的写法以及仍需补证的结论。

**学习资料**

- [亚马逊投放学习资料](learning/亚马逊投放学习资料.md)：按知识与实操主题整理的系统学习资料和来源索引。
- [亚马逊投放速成_面向自动化](learning/亚马逊投放速成_面向自动化.md)：面向自动化实现的速成路径，强调概念、数据口径和执行边界。
- [亚马逊投放学习计划_4周](learning/亚马逊投放学习计划_4周.md)：可直接执行的四周学习与练习安排。
- [信息源聚合评估_2026-09-21](learning/信息源聚合评估_2026-09-21.md)：对候选信息源、聚合工具及其许可和可用性进行评估。

实现与集成部分见 [Wany-i/jev-ads-analysis](https://github.com/Wany-i/jev-ads-analysis) 仓库。
